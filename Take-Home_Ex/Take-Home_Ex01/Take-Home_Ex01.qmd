...
The plot shows that for singles, there seems to be 2 main humps at Joviality scores of 0.2 and 0.9 i.e. singles experience a varying range of happiness with some being happier than others. For married couples and those with children, joviality scores tend to be lower. 

The Kruskal-Wallis rank sum test was non-significant with a p-value > 0.05, indicating that joviality was not influenced by marital status.
