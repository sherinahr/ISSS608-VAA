...
Today's hands-on exercise is about network visualisation, where four network data modelling and visualisation packages will be installed and launched. The objectives are as follows:
...
## **5.3 Creating network objects using tidygraph**
...
-   [A tidy hope](https://www.data-imaginist.com/2018/tidygraph-1-1-a-tidy-hope/)
...
## **5.4 Plotting Static Network Graphs with ggraph package**

[ggraph](https://ggraph.data-imaginist.com/) is an extension of ggplot2, making it easier to carry over basic ggplot skills to the design of network graphs. As in all network graphs, there are three main aspects to a ggraph's network graph, they are:
...
In this section, you will use [theme_graph()](https://ggraph.data-imaginist.com/reference/theme_graph.html) to remove the x and y axes. Before your get started, it is advisable to read its reference guide at least once.
...
## **5.7 Building Interactive Network Graph with visNetwork**
...
In the code chunk below, Fruchterman and Reingold layout is used. Visit [Igraph](http://datastorm-open.github.io/visNetwork/igraph.html) to find out more about visIgraphLayout's argument.
